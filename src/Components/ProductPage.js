...
const ProductPage = () => {
    ...
    const paymentHandler = async () => {
        ...
        try {
            const keyResponse = await fetch("https://mystoreserver-production-d64e.up.railway.app/api/v1/getkey");
            ...
            const checkoutResponse = await fetch("https://mystoreserver-production-d64e.up.railway.app/api/v1/checkout", {
                method: "POST",
                headers: {
            ...
            const options = {
                ...
                handler: async (response) => {
                    ...
                    try {
                        const res = await fetch(`https://mystoreserver-production-d64e.up.railway.app/api/v1/paymentverification`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
    ...
    const addToCartHandler = async () => {
        ...
        try {
            const res = await fetch('https://mystoreserver-production-d64e.up.railway.app/api/v1/addtocart', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
